// gz_harmonic/src/UwbChannelModel_tables.cc
// Tables copied VERBATIM from src/UwbPlugin.cpp (lines 44-624).
// Only the C++ identifier names are changed (prefixed with k).
#include "gtec_uwb/UwbChannelModel.hh"

namespace gtec_uwb {
namespace {

// rangingStd[141][3] — verbatim from UwbPlugin.cpp lines 44-187
const double kRangingStd[141][3] =
{
...
// rssMean[141][3] — verbatim from UwbPlugin.cpp lines 190-333
const double kRssMean[141][3] =
{
    {-78.87, -80.479, -88.205},
    {-78.87, -80.479, -88.205},
    {-78.87, -80.479, -88.205},
...
// rssStd[141][3] — verbatim from UwbPlugin.cpp lines 335-478
const double kRssStd[141][3] =
{
...
// minPower[3] — verbatim from UwbPlugin.cpp line 480
const double kMinPower[3] = {-94.5, -94.5, -94.5};

// rangingOffset[141][2] — verbatim from UwbPlugin.cpp lines 481-624
const double kRangingOffset[141][2] =
{
    {-87.505, 228.73},
    {-86.505, 229.73},
    {-85.505, 230.73},
...
double UwbChannelModel::RangingStd(int i, int s)    { return kRangingStd[i][s]; }
double UwbChannelModel::RssMean(int i, int s)       { return kRssMean[i][s]; }
double UwbChannelModel::RssStd(int i, int s)        { return kRssStd[i][s]; }
double UwbChannelModel::RangingOffset(int i, int c) { return kRangingOffset[i][c]; }
double UwbChannelModel::MinPower(int s)             { return kMinPower[s]; }
